...
public class MenorPrecioTest {
    ...
    private LineaNaviera linea1, linea2;
    ...
    public void setUp() {
        ...
        linea2 = new LineaNaviera("lineados", 75.0 );
        linea2.registrarCircuito(circuito3);
        

        lineas = new ArrayList<LineaNaviera>();
        lineas.add(linea1); lineas.add(linea2);
    }

    @Test
    public void testSeleccionaElCircuitoConMenosPuertos() {
        CircuitoMaritimo resultado = menorPrecio.obtenerMejorCircuito(lineas, t1, t3);
